local indexing_actions = require('nxtaar.indexing').keymaps
local code_completion_keymap = require('nxtaar.code-completion.keymaps').code_completion_keymap
local code_completion_actions = require('nxtaar.code-completion.keymaps').actions
local lsp_keymap = require('nxtaar.lsp.keymaps').lsp_keymap
local lsp_actions = require('nxtaar.lsp.keymaps').actions
local projects_actions = require('nxtaar.workspaces').actions
local git = require('nxtaar.git')
...
lsp_keymap('gD', lsp_actions.goto_declaration)
lsp_keymap('gd', lsp_actions.goto_definition)
lsp_keymap('gi', lsp_actions.goto_implementation)
lsp_keymap('gt', lsp_actions.goto_type_definition)
lsp_keymap('gr', lsp_actions.show_references)
lsp_keymap('K', lsp_actions.hover)
lsp_keymap('<C-k>', lsp_actions.signature_help)
lsp_keymap('<leader>rn', lsp_actions.rename)
lsp_keymap('<leader>x', lsp_actions.code_action)
lsp_keymap('<leader>i', lsp_actions.open_float)
lsp_keymap('[d', lsp_actions.goto_prev_diagnostics)
lsp_keymap(']d', lsp_actions.goto_next_diagnostics)
lsp_keymap('<leader>lloc', lsp_actions.set_loc_list)
